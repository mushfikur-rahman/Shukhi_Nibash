 ...
 ?>
      <div class="single_houses card">
        <div class="single_house_inner card-body">
          ...
          <div class="house_img">
            <img src="assets/images/house/22.jpg" alt="House">
          </div>
 ...
 $(function(){
   $( "#main_range" ).slider({
         ...
         slide: function( event, ui ) {
           $( "#input_range" ).val( "TK " + ui.values[ 0 ] + " - TK " + ui.values[ 1 ] );
         }
    });
    $( "#input_range" ).val( "TK " + $( "#main_range" ).slider( "values", 0 ) +
     " - TK " + $( "#main_range" ).slider( "values", 1 ) );
   });
 </script>
